...
def instructions():
    print(make_statement(statement="Instructions", decoration="ℹ"))
...
# winner announcement
lucky_winner_string = f"The lucky winner is {winner}." f"Their ticket worth {ticket_won} is free!"
